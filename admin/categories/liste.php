                ...
                <div class="modal-body">
                    <form action="ajout.php" method="post" id="addform">
                        ...
                        <div class="form-group" id="blocknom">
                            <input type="text" name="nom" maxlength="100" id="nom" class="form-control" placeholder="nom de categorie ...">
                        </div>
                        <div class="form-group">
                            <textarea name="description" required maxlength="100" minlength="5" class="form-control" placeholder="description de categorie ..."></textarea>
                        </div>
