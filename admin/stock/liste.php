            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Modifier stock de <span class="text-primary">
                                '<?php echo $s["nom"]; ?>'
                            </span></h5>
                    ...
                    <div class="modal-body">
                        <form action="modifier.php" method="post">
                            ...
                            <input type="hidden" value="<?php echo $s['id']; ?>" name="idstock">
                            <div class="form-group">
                                <input type="number" min="0" name="quantite" class="form-control" value="<?php echo $s["quantite"]; ?>">
                            </div>
    ...
    <script>
        $('#addform').submit(function() {
            if ($('#nom').val() == "") {
                ...
                return false; // Don't execute the 'ajout' in that case
            }
        })
    </script>
    <script>
